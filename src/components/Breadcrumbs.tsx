...
const pageMeta: Record<Page, PageMeta> = {
  agent: {
    label: "AI-помощник",
    title: "mat-ad.ru — сервис для настройки рекламы",
    description: "Помогаем специалистам настраивать рекламные кампании. Сервис не размещает рекламу самостоятельно.",
  },
  insights: {
    label: "Инсайты",
    group: "AI-помощник",
    groupId: "agent",
    title: "Инсайты по кампаниям · mat-ad.ru",
    description: "Сервис помогает анализировать ваши рекламные кампании и подсказывает возможные улучшения. Решение о действиях принимает пользователь.",
  },
  services: {
    label: "Тарифы",
    group: "AI-помощник",
    groupId: "agent",
    title: "Тарифы и пакеты услуг · mat-ad.ru",
    description: "Стоимость подписки и сопровождения. Конечная цена определяется индивидуально по запросу.",
  },
  ai: {
    label: "ИИ-генератор",
    group: "Творчество",
